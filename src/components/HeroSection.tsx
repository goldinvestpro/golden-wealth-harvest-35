...
export const HeroSection = () => {
  return (
    <div className="relative bg-gradient-to-b from-navy-500 to-navy-400 text-white py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl">
          ...
          <Button
            className="bg-gold-300 text-navy-500 hover:bg-gold-400 transition-all"
            size="lg"
          >
